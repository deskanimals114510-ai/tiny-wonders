(function () {
  ...
  var QUESTIONS = [
    ...
    {
      statement: "シマウマの縞模様が濃く発達している地域ほど、吸血バエ・アブが多い傾向がある。",
      answer: true,
      explain: "UC Davisの研究チームが5つの仮説を地理的分布データで比較した結果、縞の濃さと吸血バエの生息密度に強い相関が見つかりました。",
      link: "zatsugaku/shimauma.html",
      title: "シマウマの縞模様はなぜ? 有力なのは吸血バエ対策説"
    },
    {
      statement: "犬は、好ましい相手を見るとしっぽを左寄りに大きく振る。",
      answer: false,
      explain: "実際は逆で、好ましい相手には右寄り、警戒する相手には左寄りに振ります。脳の左右差が関係していると考えられています。",
      link: "zatsugaku/inu-shippo.html",
      title: "犬のしっぽ、右に振るか左に振るかで気持ちがわかる?"
    },
    {
      statement: "うさぎが食べる「盲腸便」には、1日の必要量の100倍ものビタミンB12が含まれている。",
      answer: true,
      explain: "盲腸便は腸内細菌が作る栄養たっぷりの糞で、粗タンパク質約28〜30%に加え、ビタミンB12も必要量の100倍が合成されています。",
      link: "zatsugaku/usagi-fun.html",
      title: "うさぎはなぜ自分のフンを食べるの? 実は「二度目の食事」だった"
    },
    {
      statement: "カバは水中生活に適応した体を持ちながら、実は泳ぐことも浮くこともできない。",
      answer: true,
      explain: "体の密度が高すぎて浮力を得られず、川底を蹴ったり歩いたりして水中を移動しています。",
      link: "zannen/kaba.html",
      title: "カバはなぜ泳げないの?水の達人なのに浮けない体"
    },
    {
      statement: "猫が甘いものに興味を示さないのは、しつけの影響である。",
      answer: false,
      explain: "実際は遺伝子レベルの理由で、甘味受容体をつくる遺伝子(Tas1r2)が壊れており、そもそも甘さを感じられません。",
      link: "zannen/neko-amami.html",
      title: "猫は甘さを感じられない?ケーキを前にしても無反応な理由"
    },
    {
      statement: "ハムスターの頬袋は、炎症や加齢などをきっかけに反転してしまうことがある。",
      answer: true,
      explain: "「頬袋脱」と呼ばれる症状で、頬袋が裏返って口から飛び出したまま戻らなくなることが実際に報告されています。",
      link: "zannen/hamster-hoobukuro.html",
      title: "ハムスターの頬袋、実は反転して口から飛び出すことも"
    },
    {
      statement: "インコなど鳥は具合が悪いと、見た目にもすぐ分かりやすい。",
      answer: false,
      explain: "野生では弱った個体が天敵に狙われやすいためか、鳥は具合が悪くても元気なふりをする習性があるとされ、飼い主が気づいた時にはすでに進行していることも多いとされています。",
      link: "zannen/inko-gaman.html",
      title: "インコは具合が悪くても我慢してしまう、鳥のざんねんな習性"
    },
    {
      statement: "JKCの統計によると、ダックスフンドは1999年から2025年まで一貫して登録頭数1位を守り続けている。",
      answer: false,
      explain: "実際は2003年に171,144頭でピークを迎えたあと減少が続き、2025年は3位。26年間で最も劇的な浮き沈みを見せた犬種です。",
      link: "zatsugaku/inu-ninki.html",
      title: "犬種の人気は26年でどう変わった? JKC登録データで見る栄枯盛衰"
    },
    {
      statement: "環境省の統計によると、保護された犬猫が飼い主のもとに戻るか譲渡される割合は、2004年度も2024年度も大きくは変わっていない。",
      answer: false,
      explain: "実際は2004年度の7.0%から2024年度は82.5%まで劇的に改善しています。20年で全国の状況は大きく変わりました。",
      link: "zatsugaku/hogo-jotoritsu.html",
      title: "保護犬猫の譲渡率、20年でどう変わった?"
    }
  ];
